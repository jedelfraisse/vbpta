...
namespace SiteEngine.Migrations
{
    ...
    [Migration("20260828183534_AddOrganizationPublicPresence")]
    partial class AddOrganizationPublicPresence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiteEngine.Entities.OperationalCycle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OperationalCycles", (string)null);
                });

            modelBuilder.Entity("SiteEngine.Entities.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SiteEngine.Entities.OrganizationLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsSiteEligible")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("OrganizationTypeId", "Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("SiteEngine.Entities.ParentAccessGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ChildOrganizationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ParentOrganizationId", "ChildOrganizationId")
                        .IsUnique();

                    b.ToTable("ParentAccessGrants", (string)null);
                });
            ...
            modelBuilder.Entity("SiteEngine.Entities.OperationalCycle", b =>
                {
                    b.HasOne("SiteEngine.Entities.OrganizationType", "OrganizationType")
                        .WithMany()
            ...
            modelBuilder.Entity("SiteEngine.Entities.Organization", b =>
                {
                    b.HasOne("SiteEngine.Entities.OrganizationLevel", "OrganizationLevel")
                        .WithMany()
                    ...
                    b.HasOne("SiteEngine.Entities.Organization", "ParentOrganization")
            ...
            modelBuilder.Entity("SiteEngine.Entities.ParentAccessGrant", b =>
                {
                    b.HasOne("SiteEngine.Entities.Organization", "ChildOrganization")
                        .WithMany()
